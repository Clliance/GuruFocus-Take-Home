...
import AdminNewBlog from "../adminNewBlog/AdminNewBlog";
import AdminManagerTags from "../adminManagerTags/AdminManagerTags";
import AdminManagerBlog from "../adminManagerBlog/AdminManagerBlog";
                            ...
                            <div className={style.container}>
                                ...
                                <div className={style.contentContainer}>
                                    <Switch>
                                        ...
                                        <Route path={`${url}/newBlog`} component={AdminNewBlog}/>
                                        <Route path={`${url}/managerBlog`} component={AdminManagerBlog}/>
